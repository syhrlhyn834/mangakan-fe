<template>
  <div class="pt-4">
    <form @submit.prevent="storecharacter">
      <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
          <h2 class="text-base font-semibold leading-7 text-gray-900">Character</h2>
          <p class="mt-1 text-sm leading-6 text-gray-600">Untuk Menyimpan data character Manga.</p>
...
export default {
  ...
  methods: {
      //storecharacter method
      async storecharacter() {

          //sending data to server
          await this.$axios.post('/api/admin/characters', {
